...
const SignIn = () => {
  ...
  return (
    <div>
     ...
     <div className='max-w-full mx-auto my-20 h-full '>
      ...
      <form className=' p-5  ' >
        ...
        <p className=' px-2 text-xl font-light mb-10'>Enter your details to create an account with us</p>
       ...
       <button type='submit' className='bg-blue-500 w-full p-2 my-3 text-white text-xl'>Sign Up</button>
        ...
        <div className=' flex gap-3 '>
         ...
         <img src={line} alt="" className='h-[1px] w-[220px] mt-3' />
          ...
          <button className='w-full text-xl font-semibold my-2 bg-blue-500 p-2 text-white' >Sign in with Google</button>
